...
class _ZakatPageState extends State<ZakatPage> {
  ...
  Future<void> _fetchGoldPrice() async {
    ...
    try {
      ...
      if (exchangeRes.statusCode == 200) {
        ...
        usdToIdr = 15000;
        print("⚠ Gagal ambil kurs, fallback Rp $usdToIdr");
      }
      ...
      final goldRes = await http.get(
        Uri.parse('goldapi-1wwsrsmhk7zyku-io'),
        headers: {
      ...
      if (goldRes.statusCode == 200) {
        ...
        if (pricePerGram! < 1800000 || pricePerGram > 2600000) {
          print("⚠ Harga emas tidak realistis ($pricePerGram). Gunakan fallback.");
  ...
  void _calculateZakat() {
    ...
    /// ⿡ Ambil input gaji & pengeluaran
    /// ⿢ Bersihkan format (hilangkan titik, koma, .00)
    /// ⿣ Validasi input
    /// ⿤ Hitung zakat (2.5% dari penghasilan bersih)
    /// ⿥ Bandingkan dengan nisab untuk menentukan wajib/tidak
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (_isOffline)
                          const Text(
                            "⚠ Mode offline: data diambil dari cache lokal",
                            style: TextStyle(
                        ...
                        children: [
                          Text(
                            _isAboveNisab
                                ...
                                : "ℹ Anda BELUM mencapai nisab zakat.",
                            style: TextStyle(
                              fontFamily: 'PoppinsSemiBold',
                              color: _isAboveNisab
                                  ? Colors.green
